...
import ec.edu.itq.programacion2.control.Product.InventoryStatus;
...
public class ProductService {
    ...
    public void init() {
        ...
        products.add(new Product(1000, "f230fh0g3", "Pastel de Mora", "Brazo de Pastel", "../../Web Pages/resources/images/pastel_mora.jpg", 65, "Productos a Elegir", 24, InventoryStatus.INSTOCK, 5));
